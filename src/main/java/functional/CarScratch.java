...
public class CarScratch {
    static <E> ToIntFunction<E> compareWithThat(E target, Comparator<E> comp) {
        return x -> comp.compare(target, x); //matching ToIntFunction<E>
    }
    ...
    public static <E> Predicate<E> comparesGreater(ToIntFunction<E> comp) {
        return x -> comp.applyAsInt(x) < 0; //apply then return
    } //
    ...
    public static <E> Car.Criterion<E> negate(Car.Criterion<E> crit) {
        return x -> !crit.test(x);
    }

    public static <E> Car.Criterion<E> negate(Car.Criterion<E> c1, Car.Criterion<E> c2) {
        return x -> c1.test(x) && c2.test(x);
    }
    ...
    static <E> List<E> getRedCars(List<E> in, Car.Criterion<E> crit) {
    ...
    class PassengerCntOrder implements Comparator<Car> {
        @Override
    ...
    public static void main(String[] args) {
        ...
        cars.sort((a, b) -> a.getGasLevel() - b.getGasLevel());
